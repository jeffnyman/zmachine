...
C  YEA IS RANDOM YES/NO REPLY
	...
	LOGICAL TOTING,HERE,AT,BITSET,FORCED,DARK,PCT,WZDARK,LMWARN,
	1	CLOSNG,PANIC,CLOSED,GAVEUP,SCORNG,DEMO,YEA
...
C  K COUNTS IF A TREASURE IS HERE.  IF NOT, AND TALLY=TALLY2 PLUS ONE FOR AN
C  UNSEEN CHEST, LET THE PIRATE BE SPOTTED.  USE PLACE(MESSAG) TO DETERMINE IF
C  PIRATE'S BEEN SEEN, SINCE PLACE(CHEST)=0 COULD MEAN HE THREW IT TO TROLL.
...
3000	CALL A5TOA1(WD1,WD1X,'".',TK,K)
	TYPE 3001,(TK(I),I=1,K)
